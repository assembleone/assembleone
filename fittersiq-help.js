...
// Studio only: add a simple bottom Back control to the How It Works menu.
// This deliberately does not change the workflow steps, wording, order, or job logic.
(function(){
  ...
  function initHowItWorksBack(){
    addHowItWorksBack();
    const observer=new MutationObserver(addHowItWorksBack);
    observer.observe(document.body,{subtree:true,childList:true,attributes:true,attributeFilter:["class"]});
  }

  if(document.readyState==="loading") document.addEventListener("DOMContentLoaded",initHowItWorksBack);
  else initHowItWorksBack();
})();
